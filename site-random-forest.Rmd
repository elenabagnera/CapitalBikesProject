...
## line plot fo RMSE for comparison between models
plot <- collect_metrics(tune_results, summarize = FALSE)
...
RF <- plot %>% 
  ...
  labs(title = "Calculated RMSE Across the 10 Folds - Random Forests Regression",
       y = "RMSE_hat") +
  theme_minimal()
