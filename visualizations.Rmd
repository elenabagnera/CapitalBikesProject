...
train_data_date %>%
  ...
  ggplot(aes(x = lincoln_memorial_departures))+
  geom_density() # this is showing that it is heavily skewed and we might want to transform our dependent variable in our random forest. Aaron said we should look at Box Cox or Eon Johnson transformation. Or simple log
```
