...
# density plot (no log)
train_data_date %>%
  ggplot(aes(x = log(lincoln_memorial_departures)))+
  geom_density()
...
bar_date <- train_data_date %>%
  ...
  summarise(lincoln_memorial_departures=sum(lincoln_memorial_departures))
...
holidays_date %>%
  ggplot(aes(y=lincoln_memorial_departures, x=holiday, fill=lincoln_memorial_departures)) + 
  geom_bar(stat="identity")+
  geom_hline(yintercept = 1279, color="blue")+ ## 1279 is the mean ridership per day
  xlab("") +
