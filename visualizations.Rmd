...
train_data_date %>%  # for me here there is a weird gap after July 2020, not sure why?
  ggplot(aes(x = factor(date), y = lincoln_memorial_departures)) +
...
train_data_date %>%
  ...
  geom_col(alpha = 0.1, color = "deepskyblue2") + # people cycle more in the middle of the day, like between 1 and 7PM
  geom_smooth() +
  theme_minimal() +
