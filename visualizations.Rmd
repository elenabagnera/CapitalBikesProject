...
train_date_date %>%
  filter(type != "arrivals") %>%
  ggplot(aes(x=lincoln_memorial))+
  geom_density()
```
...
train_date_date %>%
  filter(lincoln_memorial != 0) %>% # notice that we here are dropping 0s because then the visualization will be much clearer
  filter(type != "arrivals") %>%
  ggplot(aes(x=lincoln_memorial))+
...
train_date_date %>%  # for me here there is a weird gap after July 2020, not sure why?
  filter(type != "arrivals") %>%
  ggplot(aes(x = date, y = lincoln_memorial)) +
...
train_date_date %>% 
  filter(type != "arrivals") %>%
  ggplot(aes(x = day, y = lincoln_memorial)) +
...
train_date_date %>%
  filter(type != "arrivals") %>%
  ggplot(aes(x = hour, y = lincoln_memorial)) +
...
train_date_date %>% 
  filter(type != "arrivals") %>%
  ggplot(aes(x = month, y = lincoln_memorial)) +
...
train_date_date %>% # something is off with the year variable, how can we remove the space in the middle?
  filter(type != "arrivals") %>%
  ggplot(aes(x = year, y = lincoln_memorial)) +
