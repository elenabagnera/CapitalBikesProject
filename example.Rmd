...
```{r test_lag, warning=FALSE, message=FALSE}
# Just testing one data point to make sure lag is correct.
# lagged_data's lincoln_memorial column should match the hour_data's 
#  lincoln memorial from 14 days prior.
# lagged_data's departures should match hour_data's lincoln memorial departures from the same date.
hour_data %>% 
