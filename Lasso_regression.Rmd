---
title: "Model 3: Lasso Regression"
author: ""
date: ""
...
The LASSO regression produced an average RMSE of 4. This is a relatively big RMSE compared to what we aim for (range 2-3). 

This could be due to several weaknesses pertaining to LASSO. With the RMSE around 5, it is likely that we have a model that badly overfits the data. i.e. We've created a model that tests well in sample, but has little predictive value when tested out of sample.
