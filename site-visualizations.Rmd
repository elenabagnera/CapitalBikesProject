...
train_data_date %>% 
  ...
  theme_minimal() +
  labs(title = "On August 15, the highest demand occured at 12pm and 2pm",
       x = "Hour",
       y = "The Number of Departures at Lincoln Memorial") +
  theme(plot.title = element_text(face = "bold", size = 13))
```
...
holidays_date %>%
  ...
  theme(plot.title = element_text(face = "bold", size = 11, hjust = 0.5, vjust = 2))
```
...
```{r temperatures_month, include = TRUE}
