...
* Using the lubridate package to standardize and generate time-relevant predictors 9such as weekday)
* Getting hourly data
* Separating departures from arrivals
* Filtering stations from Lincoln memorial based on a given parameter
* Lagging data by 14 days in order to be able to use it as predictors
